...
<%@ taglib prefix="fn" uri="http://aleksandrchistov.ru/functions" %>
<html>
<jsp:include page="fragments/headTag.jsp"/>
<body>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/webjars/datetimepicker/2.5.20-1/jquery.datetimepicker.css">
<script src="${pageContext.request.contextPath}/webjars/datetimepicker/2.5.20-1/build/jquery.datetimepicker.full.min.js" defer></script>
